Not just a simple parser bacause of specific structure of steam item site, where prices are not just a static values, but json elements coming from Steam API<br>
